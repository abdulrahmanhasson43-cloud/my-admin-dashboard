...
// Category metadata now lives in the domain layer (types/expense). Re-export
// it here to preserve backward compatibility for any remaining importers.
export { expenseCategories, getCategoryMeta } from '@/types/expense';
