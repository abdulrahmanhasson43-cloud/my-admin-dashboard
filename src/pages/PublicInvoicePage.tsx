...
const invoiceStatusConfig: Record<string, { label: string; color: string }> = {
  paid: { label: 'مدفوعة', color: 'var(--vuno-success)' },
  pending: { label: 'قيد الانتظار', color: 'var(--vuno-warning)' },
  cancelled: { label: 'ملغاة', color: 'var(--vuno-danger)' },
};
            ...
            <div className="border-t border-[var(--vuno-border)] pt-4 space-y-2">
              ...
              >
                ...
                <span
                  ...
                  style={{ color: invoiceStatusConfig[invoice.status]?.color ?? 'var(--vuno-primary)' }}
                >
