...
// Pre-canned default response for demo (API integration point marked)
const defaultResponse = 'أنا المساعد الذكي بتاع Vuno. مقدر أساعدك في تحليل المبيعات، إدارة المخزون، تتبع المصروفات، وتقارير الأداء. إيه اللي تحب تعرفه؟';

const SIMULATED_RESPONSE_DELAY_MS = 1200; // مدة إظهار مؤشر "بيكتب..." قبل الرد التجريبي
