...
export default function ShiftsPage() {
  ...
  const handleOpen = async () => {
    ...
    const shift = await openShift(cashierName.trim(), amount);
  ...
  const handleClose = async () => {
    ...
    if (variance === 0) {
      ...
      toast.error(`عجز في الصندوق: ${Math.abs(variance).toLocaleString()} EGP`);
    }
    addNotification({
      type: 'shift',
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        ...
                        style={{
                          background: 'color-mix(in srgb, var(--vuno-success) 12%, transparent)',
                          color: 'var(--vuno-success)',
                        }}
                      >
                        مغلقة
                      </span>
