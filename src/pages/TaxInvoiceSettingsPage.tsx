...
const SAVED_TOAST_DURATION_MS = 2500;
...
export default function TaxInvoiceSettingsPage() {
  ...
  const handleSave = () => {
    setSaved(true);
    setTimeout(() => setSaved(false), SAVED_TOAST_DURATION_MS);
  };
      ...
      <motion.div
        ...
        style={{
          background: connectionStatus === 'connected'
            ...
            : 'color-mix(in srgb, var(--vuno-warning) 8%, white)',
          border: `1px solid ${connectionStatus === 'connected' ? 'color-mix(in srgb, var(--vuno-success) 20%, transparent)' : 'color-mix(in srgb, var(--vuno-warning) 20%, transparent)'}`,
        }}
      >
        <div
          ...
          style={{
            background: connectionStatus === 'connected'
              ...
              : 'color-mix(in srgb, var(--vuno-warning) 15%, transparent)',
          }}
        >
          {connectionStatus === 'connected'
            ? <CheckCircleIcon size={20} className="text-[var(--vuno-success)]" />
            : <AlertTriangleIcon size={20} className="text-[var(--vuno-warning)]" />}
        </div>
