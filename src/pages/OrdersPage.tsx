...
export default function OrdersPage() {
  // Data + mutations now flow entirely through OrderService (via
  // useOrders()) instead of a raw useState + directly-imported mock array.
  // This page has zero knowledge of where orders actually live.
