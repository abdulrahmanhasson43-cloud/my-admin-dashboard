...
/**
 * يحوّل أي قيمة خطأ (Error، string، unknown) إلى رسالة نصية آمنة للعرض.
 * يُستخدم في طبقة العرض (contexts/hooks) لعرض سبب الفشل للمستخدم بدل
 * ابتلاع الخطأ — أي خطأ غير معروف يرجع رسالة عربية عامية واضحة.
 */
