...
export function AppSettingsProvider({ children }: { children: ReactNode }) {
  // Payment methods come from the clean Settings service (never the mock layer).
  ...
  // Payment methods are loaded asynchronously from the Settings service.
  useEffect(() => {
    let active = true;
    settingsService.getPaymentMethods().then(methods => {
