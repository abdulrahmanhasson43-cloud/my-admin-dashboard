    ...
    <>
      ...
      {open && (
        <>
          ...
          />
          {/* QR modal — on mobile it's a bottom sheet that must NOT clip the
              QR code. We use max-h + overflow-y-auto + safe-area padding so
              the QR always sits above the bottom frame (issue: QR was "eaten
              from below" because the sheet had no scroll/height constraint). */}
