...
export const loyaltyLevels: LoyaltyLevelMeta[] = [
  { label: 'برونزي', minPoints: 0, color: 'text-amber-700', bgColor: 'bg-amber-100' },
  { label: 'فضي', minPoints: 500, color: 'text-gray-600', bgColor: 'bg-gray-200' },
  { label: 'ذهبي', minPoints: 1500, color: 'text-yellow-600', bgColor: 'bg-yellow-100' },
  { label: 'بلاتيني', minPoints: 3000, color: 'text-cyan-600', bgColor: 'bg-cyan-100' },
];
